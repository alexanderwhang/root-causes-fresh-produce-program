...
```
cd existing_repo
git remote add origin https://coursework.cs.duke.edu/nicole.romero.ospina/root-causes-admin.git
git branch -M main
...
- [ ] [Set up project integrations](https://coursework.cs.duke.edu/nicole.romero.ospina/root-causes-admin/-/settings/integrations)
